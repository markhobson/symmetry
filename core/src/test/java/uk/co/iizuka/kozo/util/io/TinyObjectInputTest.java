...
import uk.co.iizuka.kozo.util.io.test.CustomSerializable;
import uk.co.iizuka.kozo.util.io.test.CustomSubclassSerializable;
import uk.co.iizuka.kozo.util.io.test.MultiFieldSerializable;
import uk.co.iizuka.kozo.util.io.test.SimpleExternalizable;
import uk.co.iizuka.kozo.util.io.test.SimpleSerializable;
import uk.co.iizuka.kozo.util.io.test.SingletonSerializable;
import uk.co.iizuka.kozo.util.io.test.SubclassSerializable;
