/*
 * $HeadURL: https://svn.iizuka.co.uk/components/kozo/tags/0.6.0-beta-1/core/src/main/java/uk/co/iizuka/kozo/state/Base64StateCodec.java $
 * 
...
import uk.co.iizuka.common.bean.BeanException;
import uk.co.iizuka.common.bean.BeanIntrospector;
...
import uk.co.iizuka.common.codec.base64.Base64Alphabet;
import uk.co.iizuka.common.codec.base64.Base64InputStream;
import uk.co.iizuka.common.codec.base64.Base64OutputStream;
import uk.co.iizuka.kozo.util.io.IOUtils;
import uk.co.iizuka.kozo.util.io.SerializerFactory;
import uk.co.iizuka.kozo.util.io.SerializerTinyObjectInput;
import uk.co.iizuka.kozo.util.io.SerializerTinyObjectOutput;
import uk.co.iizuka.kozo.util.io.TinyDataInput;
import uk.co.iizuka.kozo.util.io.TinyDataOutput;
